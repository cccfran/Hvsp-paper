...
tt <- BinaryStringSBM(n,DD,beta=beta,lambda=35)
B <- tt$B
...
mega2.acc.sp.seq[I] <- accuracy(mega2.sp.Z,mega2.Z0)
...
mega4.acc.sp.seq[I] <- accuracy(mega4.sp.Z,mega4.Z0)
...
tmp <- list(nmi.HCD.seq=nmi.HCD.seq,nmi.HCD2.seq=nmi.HCD2.seq, nmi.sp.seq=nmi.sp.seq,  ncl.NB.seq=ncl.NB.seq,  ncl.HCD.seq = ncl.HCD.seq, ncl.HCD2.seq = ncl.HCD2.seq,  K.seq=K.seq,coclust.HCD.seq=coclust.HCD.seq, coclust.HCD2.seq=coclust.HCD2.seq,coclust.sp.seq=coclust.sp.seq,coclust.true.HCD.seq=coclust.true.HCD.seq,coclust.true.HCD2.seq=coclust.true.HCD2.seq,coclust.true.sp.seq=coclust.true.sp.seq,coclust.false.HCD.seq=coclust.false.HCD.seq,coclust.false.HCD2.seq=coclust.false.HCD2.seq,coclust.false.sp.seq=coclust.false.sp.seq,size.var=size.var.seq,size.ratio=size.ratio.seq,ncl.P.HCD=ncl.P.HCD.seq,ncl.P.HCD2=ncl.P.HCD2.seq,ncl.P.sp=ncl.P.sp.seq,P.err.HCD=P.err.HCD.seq,P.err.HCD2=P.err.HCD2.seq,P.err.sp=P.err.sp.seq,Scaled.FP.HCD=Scaled.FP.HCD.seq,Scaled.FP.HCD2=Scaled.FP.HCD2.seq,Scaled.FP.sp = Scaled.FP.sp.seq,Standard.FP.HCD=Standard.FP.HCD.seq,Standard.FP.HCD2=Standard.FP.HCD2.seq,Standard.FP.sp = Standard.FP.sp.seq,bin.err.HCD.seq=bin.err.HCD.seq,bin.err.HCD2.seq=bin.err.HCD2.seq,bin.err.HCD.P.seq=bin.err.HCD.P.seq,bin.err.HCD2.P.seq=bin.err.HCD2.P.seq,bin.err.sp.P.seq=bin.err.sp.P.seq,mega2.nmi.sp.seq=mega2.nmi.sp.seq, mega4.nmi.sp.seq=mega4.nmi.sp.seq , mega2.nmi.HCD.seq=mega2.nmi.HCD.seq , mega2.nmi.HCD2.seq=mega2.nmi.HCD2.seq , mega4.nmi.HCD.seq=mega4.nmi.HCD.seq , mega4.nmi.HCD2.seq=mega4.nmi.HCD2.seq, mega2.coclust.HCD.seq=mega2.coclust.HCD.seq, mega2.coclust.HCD2.seq=mega2.coclust.HCD2.seq,mega2.coclust.sp.seq=mega2.coclust.sp.seq,mega2.acc.HCD.seq=mega2.acc.HCD.seq, mega2.acc.HCD2.seq=mega2.acc.HCD2.seq,mega2.acc.sp.seq=mega2.acc.sp.seq, mega4.coclust.HCD.seq=mega4.coclust.HCD.seq, mega4.coclust.HCD2.seq=mega4.coclust.HCD2.seq,mega4.coclust.sp.seq=mega4.coclust.sp.seq,mega4.acc.HCD.seq=mega4.acc.HCD.seq, mega4.acc.HCD2.seq=mega4.acc.HCD2.seq,mega4.acc.sp.seq=mega4.acc.sp.seq,sp2.acc.seq=sp2.acc.seq,sp4.acc.seq=sp4.acc.seq)
